...
@section('content')
    ...
    <div id="card-1" class="card-rotating effect__click">
        ...
        <div class="face front">
            ...
            <!--Avatar-->
            <div class="avatar"><img src="images/jaber1.JPG" class="img img-circle img-responsive">
            </div>
            <!--Content-->
...
<div class="col-sm-3">
    ...
    <div id="card-2" class="card-rotating effect__click">
        ...
        <div class="face front">
            ...
            <!--Avatar-->
            <div class="avatar"><img src="images/dip.JPG" class="img img-circle img-responsive">
            </div>
            <!--Content-->
            <div class="card-block">
...
<div class="col-sm-3">
    ...
    <div id="card-3" class="card-rotating effect__click">
        ...
        <div class="face front">
            ...
            <!--Avatar-->
            <div class="avatar"><img src="images/jony.JPG" class="img img-circle img-responsive">
            </div>
            <!--Content-->
            <div class="card-block">
...
<div class="col-sm-3">
    ...
    <div id="card-4" class="card-rotating effect__click">
        ...
        <div class="face front">
            ...
            <!--Avatar-->
            <div class="avatar"><img src="images/mohsin.jpg" class="img img-circle img-responsive">
            </div>
            <!--Content-->
            <div class="card-block">
                <h4>Mohsin Ahmed</h4>
        ...
        <div class="face back">
            ...
            <h4>About me</h4>
            <hr>
            <p> Hi, this is Mohsin Ahmed. i am a student of CSE Department in Leading university. I am a Front-End Developer. I like most Cricket games.    </p>
            <hr>
            <!--Social Icons-->
            <ul class="inline-ul">
                <li><a class="icons-sm fb-ic"><i class="fa fa-facebook"></i></a></li>
