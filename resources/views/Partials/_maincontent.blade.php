...
<div class="card testimonial-card">
    ...
    <!--image-->
    <div class="avatar"><img src="{{asset('images/dip.jpg')}}" class="img-circle img-responsive">
    </div>
...
<div class="card testimonial-card">
    ...
    <!--image-->
    <div class="avatar"><img src="{{asset('images/jony.JPG')}}" class="img-circle img-responsive">
    </div>
...
<div class="card testimonial-card">
    ...
    <!--image-->
    <div class="avatar">
    <img src="{{asset('images/mohsin.jpg')}}" class="img-circle img-responsive">
    </div>
